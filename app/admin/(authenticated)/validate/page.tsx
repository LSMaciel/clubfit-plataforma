...
const QrScanner = dynamic(() => import('@/components/partner/qr-scanner').then(mod => mod.QrScanner), {
    loading: () => <div className="h-64 w-full bg-slate-100 animate-pulse rounded-xl flex items-center justify-center text-slate-400">Carregando Câmera...</div>,
    ssr: false
})
