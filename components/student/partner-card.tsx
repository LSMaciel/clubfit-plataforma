...
export function PartnerCard({ partner, academySlug }: PartnerCardProps) {
    ...
    // Link para ofertas filtradas
    const offersLink = `/${academySlug}/benefits?partner_id=${partner.id}`
    ...
    return (
        ...
        >
            ...
            {/* Clickable Area Overlay (para evitar conflito com o botão de mapa) */}
            ...
            <div className="flex items-start justify-between relative z-10 pointer-events-none">
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-[var(--primary-color)]/10 group-hover:text-[var(--primary-color)] transition-colors">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-900 group-hover:text-[var(--primary-color)] transition-colors">{partner.name}</h3>
